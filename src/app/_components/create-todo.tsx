...
export function CreateTodo() {
  ...
  return (
    ...
    >
      <input
        className="w-full appearance-none rounded border-gray-one py-3 px-3 leading-tight text-gray-four"
        type="text"
      ...
      />
      <button className="group flex items-center rounded-md border-cream-four bg-green-one px-6 py-3 text-lg font-semibold text-gray-five outline outline-2 outline-offset-2 outline-green-one hover:text-green-five focus-visible:outline-green-five">
        Create
        <svg
